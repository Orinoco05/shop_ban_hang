        ...
        <div class="row">
            ...
            <div class="col-12">
                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                        <a class="nav-link active" href="index.php?controller=detailAdmin&action=add"><i
                                ...
                                foreach ($array['infor'] as $product) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a style="color: white"
                                                href="index.php?controller=detailAdmin&action=destroy&id=<?= $product['ID_product_detail'] ?>"><button
                            ...
                            <nav aria-label="...">
                                <ul class="pagination pagination-lg">
                                    ...
                                    for ($i = 1; $i <= $array['page']; $i++) {
                                        ?>
                                        <li class="page-item">
                                            <form method="post" action="index.php?controller=detailAdmin&page=<?= $i ?>">
